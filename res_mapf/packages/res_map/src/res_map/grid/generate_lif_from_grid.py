...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--width", type=int, required=True, help="Grid width (number of columns)")
    parser.add_argument("--height", type=int, required=True, help="Grid height (number of rows)")
    parser.add_argument(
        "--spacing",
        type=float,
        default=1.0,
